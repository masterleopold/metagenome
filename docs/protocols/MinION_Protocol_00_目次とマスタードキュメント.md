...
**作成日**: 2025年10月8日
**バージョン**: 2.1
**最終更新**: 2025年11月13日（Protocol 12 v2.1 - 環状DNA・ssDNAウイルス対応）
...
### 💡 推奨プロトコル（2025年11月更新 - v2.1）

**初めて本プロトコルを使用される方へ**: 最も簡素化され効率的な **Protocol 12「統合サンプル調製プロトコル」** から開始することを強く推奨します。

- ✅ **全91病原体対応** （100%真の完全カバレッジ - 環状DNA・ssDNA対応）
- ✅ **2つのワークフローのみ** （DNA + RNA）
- ✅ **実験時間15.5時間** （環状DNA・ssDNA処理を含む）
- ✅ **コスト¥162,000/サンプル** （環状DNA・ssDNA処理 +¥5,000含む）
- ✅ **LOD 100-500 copies/mL** （PCV2/PCV3/TTV/PPV含むすべての病原体）

**重要更新 (v2.1)**: 環状ssDNAウイルス（PCV2/PCV3/TTV）および直鎖ssDNAウイルス（PPV）の検出を保証するため、**Step 2.5（環状DNA直鎖化・ssDNA→dsDNA変換）**を追加しました。これにより真の91/91病原体検出が可能になります。
...
| **12** | **`MinION_Protocol_12_統合サンプル調製プロトコル.md`**    | **✨ 統合プロトコル（91病原体・推奨）<br>環状DNA・ssDNA対応** | **実験15.5時間** |
...
**総所要時間**: 約15.5時間（実験時間、Step 2.5含む） + 6-48時間（シーケンス）

---- 

## コスト概算（1サンプルあたり - Protocol 12推奨）
...
**注**: 環状DNA・ssDNA処理試薬（DNase I、Klenow Fragment、Random Hexamers、dNTPs）により、PCV2/PCV3/TTV/PPV の確実な検出が可能。

※ Duplex + Triplicate実施時は約3倍（295,500円/サンプル）
